...
- Linux Agent Gateway tunnel authentication, relay reconnect/lifecycle integration, and disposable-host tests; do not expose a captured application path before those boundaries work end to end.