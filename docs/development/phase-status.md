...
Complete the portable native baseline, beginning with cross-target compilation and explicit platform capability reporting. Then create the Windows QEMU base-image harness before implementing Windows-specific credentials, service startup, trust, and packaging.