...
Implement WFP-provided Windows flow SID and original-destination metadata, then route native and captured traffic through the existing SID-keyed registry. In parallel, prepare the Apple-hardware development environment for native macOS validation.