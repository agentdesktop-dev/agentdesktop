...
- Phase 4, partial: privacy-safe local operational status API covering mode, connector version, gateway, identity readiness, and forwarding limits. Installer, application-profile UI, trust workflow, and graphical UI remain pending.
